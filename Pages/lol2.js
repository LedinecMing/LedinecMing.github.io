...
/*
И так еще одна сборка обновлений моей игры
Что добавлено:
  Прочность инструментов
  Полоска жизней
  Враждебный моб в каменном биоме, он бежит к вам и наносит 1 урон если вы с ним на одной плитке ( у игрока 100 здоровья ), с него выпадает 2 камня, у него 50 хп и 15 скорости ( у игрока 16 )
  Если голод меньше одного здоровье тратится на 5 единиц 1 раз в 5 секунд
  Если голод больше 90 здоровье будет увеличиваться по 5 единиц раз в 5 секунд и тратиться по 5 голода за это же время
  Много оптимизации, много.
  Добавлена овца, звук есть, 10 хп, 14 скорости, падает один комок шерсти ( еще нету использования, можете подсказать )
  Исправлено пару багов
  Игрок теперь появляется в середине мира
*/